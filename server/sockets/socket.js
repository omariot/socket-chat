...
io.on('connection', (client) => {
    ...
    client.on('entrarChat', (data, callback) => {
        ...
        client.broadcast.to(data.sala).emit( 'listaPersona', usuarios.getPersonasBySalas(data.sala) );
    ...
    client.on('disconnect', () => {
        ...
        client.broadcast.to(personaBorrada.sala).emit( 'listaPersona', usuarios.getPersonasBySalas(personaBorrada.sala) );
    });
